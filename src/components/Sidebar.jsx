...
export default function Sidebar() {
  ...
  useEffect(() => {
    ...
    const apply = () => {
      ...
      // En mobile => cerrado. En desktop => abierto.
      if (mq.matches) {
  ...
  return (
    <details ref={detailsRef} className="sidecollapsible">
      {/* Header compacto (solo mobile) */}
      <summary className="sidecollapsible-trigger" role="button" aria-controls="side-content">
        <div className="trigger-left">
          {/* Mini avatar: asegurate de tener /public/avatar.webp */}
      ...
      {/* Contenido completo del sidebar (card grande SOLO cuando está abierto) */}
      <div id="side-content" className="sidecard sidecard-content sidecard--mobile">
        <div className="avatar-wrap">
          <img src={avatar} alt="Leandro Mussi" className="avatar-img" />
        </div>

        <h2 className="name">Leandro Mussi</h2>
